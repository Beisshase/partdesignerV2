...
class Editor {
    ...
    constructor() {
        ...
        document.getElementById("save-part").addEventListener("click", (event) => this.savePart());
        document.getElementById("load-part").addEventListener("click", (event) => this.loadPart());
        document.getElementById("load-part-input").addEventListener("change", (event) => this.onLoadPartFile(event));
    ...
    loadPart() {
        document.getElementById('load-part-input').click();
    }
    onLoadPartFile(event) {
        ...
        reader.onload = (e) => {
            try {
                ...
                if (data.revision) {
                    document.getElementById('partRevision').value = data.revision;
                }
                this.updateMesh(true);
            }
            catch {
    ...
    clear() {
        ...
        document.getElementById('partRevision').value = '';
